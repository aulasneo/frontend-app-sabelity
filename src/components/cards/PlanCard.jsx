...
const PlanCard = ({ title, description, features, price, className, isDisabled, onPlanSelect }) => {
    const intl = useIntl();
        ...
        <Card className={`plan-card p-3 ${className}`} style={{ width: '18rem' }}>
            <Card.Body className="plan-card-body">
                ...
                <div className='card-price-content'>
                    ...
                    <div className='card-mouth'>{intl.formatMessage(messages.suscribeMouth)}</div>
                </div>
